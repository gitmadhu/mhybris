...
<c:if test="${not empty facetData.values}">
	<div class="facet product_grid_line <c:if test='${facetIndex > 2}'>facet_hide</c:if> ">
		<div class="facetHead">
			...
			<div class="facetValues">
				<c:if test="${not empty facetData.topValues}">
					<div class="topFacetValues clearfix">
						<ul class="facet_block ${facetData.multiSelect ? '' : 'indent'} clearfix">
				...
				<div class="allFacetValues clearfix  <c:if test='${not empty facetData.topValues}'>hasmore</c:if>" style="${not empty facetData.topValues ? 'display:none' : ''}">
					<ul class="facet_block ${facetData.multiSelect ? '' : 'indent'} clearfix">
