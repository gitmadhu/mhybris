...
PORT=9001
SECURE_PORT=9002
BASE="http://${HOST}:${PORT}/${WEBROOT}/v1/wsTest"
SECURE_BASE="https://${HOST}:${SECURE_PORT}/${WEBROOT}/v1/wsTest"
...
LOGOUT_URL="https://${HOST}:${SECURE_PORT}/${WEBROOT}/v1/customers/current/logout"
